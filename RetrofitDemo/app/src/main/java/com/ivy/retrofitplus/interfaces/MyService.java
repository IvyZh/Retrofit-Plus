package com.ivy.retrofitplus.interfaces;

import com.ivy.retrofitplus.domain.CurrentUserInfo;
import com.ivy.retrofitplus.domain.MoviesBean;
...
public interface MyService {
    ...
    @FormUrlEncoded
    Call<String> login(@Field("email") String email, @Field("password") String password, @Field("ememberme") int ememberme);

    // GET请求
    @GET("app/userinfo")
    Call<CurrentUserInfo> getUserInfo();
